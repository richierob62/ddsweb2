...
const DetailsField = props => {
  ...
  const suffixed_field_name =
    ref_table_name === undefined ? field_name : field_name + '_id'
  ...
  return <FieldWrapper>{chosen_component()}</FieldWrapper>
}
