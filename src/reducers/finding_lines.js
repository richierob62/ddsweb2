...
const finding_lines = (state = initial_state, action) => {
    switch (action.type) {
        ...
        case 'BEGIN_FINDING_LINE_CREATE': {
        ...
        case 'BEGIN_FINDING_LINE_DUPLICATE': {
        ...
        case 'BEGIN_FINDING_LINE_DELETE': {
            return state.set('mode', 'delete')
        }

        case 'SAVE_FINDING_LINE_COMPLETED': {
        ...
        case 'DELETE_FINDING_LINE_COMPLETED': {
            const id = state.get('selected_id')
        ...
        case 'LOAD_FINDING_LINE_LIST_COMPLETED': {
        ...
        case 'LOAD_FINDING_LINE_REFERENCE_COMPLETED': {
            const newList = Immutable.fromJS(action.payload)
