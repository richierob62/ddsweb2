...
const initial_state = Immutable.fromJS({
    ...
    mode: 'display',
    fields: {
        account_num: { label: 'Acc #', input_type: 'text', ref_table: undefined, readonly: true },
        address: { label: 'Address', input_type: 'text', ref_table: undefined },
        advanced_training: { label: 'Adv Training', input_type: 'text', ref_table: undefined },
        affiliated_clinics: { label: 'Affil Clinics', input_type: 'text', ref_table: undefined },
        affiliated_networks: { label: 'Affil Networks', input_type: 'text', ref_table: undefined },
        area: { label: 'Area', input_type: 'text', ref_table: undefined },
        billing_address: { label: 'Billing Address', input_type: 'text', ref_table: undefined },
        billing_area: { label: 'Billing Area', input_type: 'text', ref_table: undefined },
        billing_city: { label: 'Billing City', input_type: 'text', ref_table: undefined },
        billing_contact: { label: 'Billing Contact', input_type: 'text', ref_table: undefined },
        billing_email: { label: 'Billing Email', input_type: 'text', ref_table: undefined },
        billing_name: { label: 'Billing Name', input_type: 'text', ref_table: undefined },
        billing_phone: { label: 'Billing Phone', input_type: 'text', ref_table: undefined },
        billing_state: { label: 'Billing State', input_type: 'text', ref_table: undefined },
        billing_zip: { label: 'Billing Zip', input_type: 'text', ref_table: undefined },
        building: { label: 'Building', input_type: 'text', ref_table: undefined },
        category: { label: 'Category', input_type: 'select', ref_table: 'category' },
        certification: { label: 'Certification', input_type: 'text', ref_table: undefined },
        city: { label: 'City', input_type: 'text', ref_table: undefined },
        department: { label: 'Department', input_type: 'text', ref_table: undefined },
        director: { label: 'Director', input_type: 'text', ref_table: undefined },
        email: { label: 'Email', input_type: 'text', ref_table: undefined },
        entered_public_practice: { label: 'Ent Pub Prctce', input_type: 'text', ref_table: undefined },
        fax_area: { label: 'Fax Area', input_type: 'text', ref_table: undefined },
        fax_phone: { label: 'Fax Phone', input_type: 'text', ref_table: undefined },
        fellowship: { label: 'Fellowship', input_type: 'text', ref_table: undefined },
        hospital_affiliations: { label: 'Hospital Affil', input_type: 'text', ref_table: undefined },
        hours: { label: 'Hours', input_type: 'text', ref_table: undefined },
        local_foreign: { label: 'Local Foreign', input_type: 'select', ref_table: 'local_foreign' },
        ...
        website: { label: 'Website', input_type: 'text', ref_table: undefined },
