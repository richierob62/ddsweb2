...
const categories = (state = initial_state, action) => {
    switch (action.type) {
        ...
        case 'LOAD_CATEGORY_LIST_COMPLETED':
            {
        ...
        case 'LOAD_CATEGORY_REFERENCE_COMPLETED':
            {
                const newList = Immutable.fromJS(action.payload)
